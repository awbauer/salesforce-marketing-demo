/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=CloudflareBindings apps/edge/src/worker-configuration.d.ts` (hash: 96518a9e305bb61922ff46de06f18f35)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "AUTH_MODE" | "PROOF_WORKSPACE_ID" | "AI_GATEWAY_ID" | "CAMPAIGN_IMAGE_MODEL" | "SALESFORCE_MCP_URL">> {}
}
