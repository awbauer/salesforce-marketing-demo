/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=CloudflareBindings apps/edge/src/worker-configuration.d.ts` (hash: f84cc7a5983d634856225761a06da4c7)
// Runtime types generated with workerd@1.20260918.1 2026-09-24 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	...
	ENVIRONMENT: "proof";
	AUTH_MODE: "access";
	PROOF_WORKSPACE_ID: "northstar-demo";
	ORCHESTRATOR_MODEL: "@cf/openai/gpt-oss-20b";
	AI_GATEWAY_ID: "northstar-marketing-pot";
	CAMPAIGN_IMAGE_MODEL: "@cf/black-forest-labs/flux-2-klein-4b";
	SALESFORCE_MCP_URL: "https://northstar-mcp.becurious.one/mcp";
	MarketingOrchestrator: DurableObjectNamespace<import("./index").MarketingOrchestrator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "MarketingOrchestrator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "AUTH_MODE" | "PROOF_WORKSPACE_ID" | "ORCHESTRATOR_MODEL" | "AI_GATEWAY_ID" | "CAMPAIGN_IMAGE_MODEL" | "SALESFORCE_MCP_URL">> {}
}
